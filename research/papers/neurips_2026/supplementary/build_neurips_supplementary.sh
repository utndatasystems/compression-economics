...
OUTPUT_PATH="${1:-$REPO_ROOT/research/papers/neurips_2026/supplementary/neurips-2026-supplementary.zip}"
...
for relative_path in \
  research/papers/neurips_2026/experiments/tokenizer_fertility.py \
  research/papers/neurips_2026/experiments/generate_adversarial.py \
  research/papers/neurips_2026/experiments/run_compression_attacks.py \
  research/papers/neurips_2026/experiments/score_adversarial_payloads.py \
  artifacts/papers/neurips-2026/manifest.json \
  research/papers/neurips_2026/experiments/paper_evaluation.sh \
  research/papers/neurips_2026/experiments/run_all.sh \
  research/__init__.py \
  research/papers/__init__.py \
  research/papers/neurips_2026/__init__.py \
  research/papers/neurips_2026/experiments/__init__.py \
  src/__init__.py \
...
cp -- "$REPO_ROOT/research/papers/neurips_2026/supplementary/ARTIFACT_CARD.md" "$ARCHIVE_ROOT/README.md"
cp -- "$REPO_ROOT/research/papers/neurips_2026/supplementary/LICENSE" "$ARCHIVE_ROOT/LICENSE"
cp -- "$REPO_ROOT/research/papers/neurips_2026/supplementary/pyproject.toml" "$ARCHIVE_ROOT/pyproject.toml"
cp -- "$REPO_ROOT/research/papers/neurips_2026/supplementary/uv.lock" "$ARCHIVE_ROOT/uv.lock"
