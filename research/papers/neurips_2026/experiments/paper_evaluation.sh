...
run_full_generation() {
  ...
  "$PYTHON_BIN" research/papers/neurips_2026/experiments/generate_adversarial.py \
...
score_full_payloads() {
  "$PYTHON_BIN" research/papers/neurips_2026/experiments/score_adversarial_payloads.py \
    --input-dir "$FULL_DIR"
}
...
run_long_byte_attacks() {
  ...
  "$PYTHON_BIN" research/papers/neurips_2026/experiments/run_compression_attacks.py \
    --model-name "$PAPER_MODEL" \
    --start-text A \
    --start-text B \
    --start-text C \
