\begin{table}[!htbp]  %!htbp %t
  \centering
  \small
  \caption{\textbf{Tokenizer fertility on the held-out 5\,MB text8 test region
  ...
  better); bytes/token is the compression-oriented inverse (higher is
