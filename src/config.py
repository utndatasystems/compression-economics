...
def get_main_args() -> argparse.Namespace:
    ...
    parser.add_argument("--engine", type=str, choices=["transformer", "tensorrt"], default="transformer", help="Inference engine to use")
    parser.add_argument("--tensorrt_engine_dir", type=str, default=None, help="Directory containing a prebuilt TensorRT-LLM engine")
