...
def get_main_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pipeline_encoding", action="store_true", help="Pipeline arithmetic coding interval staging behind the next inference batch")
    parser.add_argument("--no_pipeline_encoding", dest="pipeline_encoding", action="store_false", help="Disable pipelined encoding")
    parser.set_defaults(pipeline_encoding=True)
